...
def main(alias_id, fleet_id, aws_region):
    total_time = 0
    while not fleet_ready_or_failed(fleet_id, aws_region):
    ...
    update_gamelift_alias(alias_id, fleet_id, aws_region)

def fleet_ready_or_failed(fleet_id, aws_region):
    result = aws_cli(
        [
            "gamelift",
...
def update_gamelift_alias(alias_id, fleet_id, aws_region):
    routing_strategy = {
        "Type": "SIMPLE",
        "FleetId": fleet_id,
    }
